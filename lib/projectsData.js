export const projects = [
  {
    id: 1,
    slug: "pawly",
    title: "Pawly – Modern Pet Adoption Platform",
    ...
    description:
      "Pawly is a modern full-stack pet adoption platform that connects adopters with pets available for adoption while providing pet owners with powerful listing and request management tools.",

    overview:
      "Pawly helps adopters discover pets, submit adoption requests, and manage their adoption journey while allowing pet owners to create, manage, and approve pet listings from a dedicated dashboard.",

    overviewDetail:
      "Pawly is a full-stack pet adoption portal built with Next.js, Express.js, MongoDB, and Better Auth. The platform provides secure authentication, dynamic pet browsing, adoption request workflows, owner dashboards, profile management, custom loading systems, and responsive user experiences across all devices.",

    techHighlights: [
      "Built full-stack pet adoption platform using Next.js and Express.js",
      "Implemented Better Auth authentication with JWT session management",
      "Developed dynamic user profile dashboard with MongoDB synchronization",
      "Created complete adoption request approval and rejection workflow",
      "Designed custom route-level loading screens and animated paw loaders",
      "Implemented advanced pet filtering, search, and category browsing",
    ],

    challenges: [
      "Integrating Better Auth with custom JWT-based API routes",
      "Keeping protected routes stable during session refreshes",
      "Managing MongoDB query filtering for search and species categories",
      "Building adoption request approval workflows",
      "Designing responsive dashboard experiences for different user roles",
    ],

    futureUpdates: [
      "Add wishlist and favorites system",
      "Add real-time chat between adopters and pet owners",
      "Implement advanced filters with breed, age, and location",
      "Add email notifications for adoption updates",
      "Develop admin dashboard for shelter management",
    ],
    ...
    stats: [
      ...
      { label: "Authentication", value: "Better Auth", color: "secondary" },
      { label: "Database", value: "MongoDB Atlas", color: "accent" },
      { label: "Architecture", value: "Next.js App Router", color: "primary" },
    ],
    ...
    image: "/images/projects/project-7/mockup.png",

    showcaseImages: [
      "/images/projects/project-7/showcase-1.png",
      "/images/projects/project-7/showcase-2.png",
      "/images/projects/project-7/showcase-3.png",
    ],

    github: "https://github.com/toufiqweb/pawly-client",

    live: "https://pawly-client.vercel.app",

    developer: {
      name: "Toufiq Alahe",
      project: "Pawly – Modern Pet Adoption Platform",
    },
  ...
  },
  {
    ...
    stats: [
      ...
      {
        label: "Cart System",
        value: "Dynamic State Management",
        color: "accent",
      },
      { label: "UI System", value: "Responsive", color: "primary" },
    ],
  ...
  },
  {
    ...
    image: "/images/projects/project-5/mockup.png",
  ...
  },
  {
    ...
    image: "/images/projects/project-6/mockup.png",
